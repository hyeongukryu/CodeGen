...
function $useSWRGetAll(_config: _SWRConfiguration = {}, _shouldFetch: boolean = true) {
...
export { $useSWRGetAll as useSWRGetAll };
...
export { $tagA as tagA };
function $useSWRTagA(_config: _SWRConfiguration = {}, _shouldFetch: boolean = true) {
...
export { $useSWRTagA as useSWRTagA };
...
function $useSWRTagATagB(_config: _SWRConfiguration = {}, _shouldFetch: boolean = true) {
...
export { $useSWRTagATagB as useSWRTagATagB };
